        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="lg:ml-64 pt-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-6">Học theo chủ đề</h2>
                            ...
                            {subjects.map((subject, index) => (
                                ...
                                >
                                    <CardContent className="p-0">
                                        <div className={`${subject.color} h-48 flex items-center justify-center relative`}>
                                            <div className="text-8xl">
                                                {subject.title === "Thể thao" && "⚽"}
                                                {subject.title === "Vũ trụ" && "🚀"}
                                                {subject.title === "Ẩm thực" && "🍽️"}
                                            </div>
                                        </div>
                                        <div className="p-6">
                                            <h3 className="text-xl font-semibold mb-3">{subject.title}</h3>
                                            <Button className="w-full bg-[#6B59CE] hover:bg-[#5a4cb4] text-white">
                                                Thử ngay
                                            </Button>
                                        </div>
                                    </CardContent>
